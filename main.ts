...
forever(function () {
    ...
    if (info.score() == 0) {
        ...
        game.splash("Your are a " + word_list[1])
    } else if (info.score() == 2) {
        game.splash("You are a " + word_list[2], "")
    } else if (info.score() == 3) {
        game.splash("You are a " + word_list[3])
    } else if (info.score() == 4) {
        game.splash("You are a " + word_list[4])
    } else if (info.score() == 5) {
        game.splash("You are a " + word_list[5])
    } else if (info.score() == 6) {
        game.splash("You are a " + word_list[6])
    } else {
        game.splash("What the heck R U?")
    }
})
